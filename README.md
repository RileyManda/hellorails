...
> Hello Rails application developed for the purpose of learning the basic ROR setup with linters,ROR route,project structure and postgresql db setup
...
```sh
  cd my-folder
  git clone https://github.com/RileyManda/hellorails.git
```
-
...
There are no future features planned for this project
